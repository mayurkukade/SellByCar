...
import { Card, CardBody, Divider, Button, Flex, Text, Box, Stack, Badge } from '@chakra-ui/react'
import { ArrowForwardIcon } from '@chakra-ui/icons';
    ...
    <Card maxW='md' mb={5}>
      <CardBody>
        ...
        <Stack direction='row' textAlign={'center'} justifyContent={'center'} >
          <Badge colorScheme='gray' fontSize={'lg'}>96,953 KM</Badge>
          <Badge colorScheme='gray' fontSize={'lg'}>2ND OWNER</Badge>
          <Badge colorScheme='gray' fontSize={'lg'}>PETROL</Badge>
          <Badge colorScheme='gray' fontSize={'lg'}>MH-04</Badge>
        </Stack>
